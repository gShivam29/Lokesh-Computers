...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Lokesh Computers!</h1>
                    <p>No need to hunt around, we have all the deals in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3>Threadripper 5990x</h3>
                                    <p>Best Price: Rs. 600000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">More deals</a></p>
                                        <?php
                                        }
                                        else{
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3>Z790</h3>
                                    <p>Best Price: Rs. 29000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <p><a href="More_Deal_11.php" role="button" class="btn btn-primary btn-block">More deals</a></p>
                                        <?php
                                        }
                                        else{
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            ...
                            <center>
                                <div class="caption">
                                    <h3>B560</h3>
                                    <p>Best Price: Rs. 12000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <p><a href="More_Deal_12.php" role="button" class="btn btn-primary btn-block">More deals</a></p>
                                        <?php
                                        }
                                        else{
